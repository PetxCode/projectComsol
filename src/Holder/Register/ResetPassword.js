...
const ResetPassword = () => {
	...
	const onSubmit = handleSubmit(async (data) => {
		console.log(data);
		const url = "https://project-comsol.herokuapp.com/api/user/forgot_password";
		...
		<Container>
			<Wrapper>
				<Content>
					<Holder>
						<HolderCard>
							<Welcome>Forgot Password?</Welcome>
							<SubTitle> Let's help you recover it back</SubTitle>
							<Form onSubmit={onSubmit}>
								...
								<Div>
									Forgot password <Span to="/">Click here to reset</Span>{" "}
								</Div>
								<LabelError>{showError ? showError : null}</LabelError>
							</Form>
						</HolderCard>
					</Holder>
				</Content>
